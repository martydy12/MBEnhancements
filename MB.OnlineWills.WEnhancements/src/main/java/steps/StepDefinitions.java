...
public class StepDefinitions extends Base {
	...
	public void user_clicks_on_new_order_on_incomplete_order_popup() throws Throwable {
		if (new WebDriverWait(driver, 30)
				.until(ExpectedConditions.visibilityOf(
						driver.findElement(By.xpath("//*[contains(text(), 'DEBUG You have an incomplete Order')]"))))
				.isDisplayed()) {
...
//		CommonFunctions.isAlertPresent(arg2, arg1);
//	}
	...
	public void user_sees_alert_message_and_clicks_on(String arg1, String arg2) throws Throwable {
		CommonFunctions.isAlertPresentWithText(arg1);
	...
	public void user_does_not_see_alert(String arg1) throws Throwable {
		CommonFunctions.waitAlertIsPresent();
	}
	...
	public void user_sees_Are_you_currently_in_hospital_question_with_no_answer_in_personal_info_summary()
			throws Throwable {
	...
	public void user_sees_Are_you_currently_in_hospital_question_with_yes_answer_in_personal_info_summary()
			throws Throwable {
	...
	public void user_checks_the_personal_info_summary_details() throws Throwable {
		...
		CommonFunctions.textVisibleInPage("Dr");
		CommonFunctions.textVisibleInPage("Date of Birth");
		// CommonFunctions.textVisibleInPage("14/11/2019");
		CommonFunctions.textVisibleInPage("First Name");
		// CommonFunctions.textVisibleInPage("dim");
		CommonFunctions.textVisibleInPage("Middle Name");
		CommonFunctions.textVisibleInPage("Family Name");
		// CommonFunctions.textVisibleInPage("camuin");
		CommonFunctions.textVisibleInPage("Residential Address");
		// CommonFunctions.textVisibleInPage("No.22 Diamond Street Bahayang Pagasa Imus
		// Cavite");
		CommonFunctions.textVisibleInPage("Email");
		// CommonFunctions.textVisibleInPage("demeth@gmail.com");
		CommonFunctions.textVisibleInPage("Phone Number");
		CommonFunctions.textVisibleInPage("4772834");
		CommonFunctions.textVisibleInPage("Occupation");
		CommonFunctions.textVisibleInPage("Consultant");
		CommonFunctions.textVisibleInPage("Postal Address");
		// CommonFunctions.textVisibleInPage("Same as Residential Address");
		CommonFunctions.textVisibleInPage("Are you currently in hospital?");
		reviewConfirmPage.HospitalNoSummary();
		CommonFunctions.textVisibleInPage(
				"Have you been diagnosed with any conditions that affect your cognition or your physical ability to read and sign your Will?");
		reviewConfirmPage.DiagnosedNoSummary();
	}
	...
	public void user_checks_the_About_you_summary_details() throws Throwable {
		...
		CommonFunctions.textVisibleInPage("Single");
		CommonFunctions.textVisibleInPage("Have you had a family law property settlement?");
		reviewConfirmPage.FamilyLawPropertyNo();
		CommonFunctions.textVisibleInPage("Do you have any children?");
	...
	public void user_checks_the_Assets_summary_details() throws Throwable {
		CommonFunctions.textVisibleInPage("Do you have any assets?");
		reviewConfirmPage.HaveAssetsNo();
		CommonFunctions.textVisibleInPage("Do you have any debts?");
		reviewConfirmPage.HaveDebtsNo();
		CommonFunctions.textVisibleInPage("Do you have any superannuation?");
		reviewConfirmPage.HaveSuperNo();
		CommonFunctions.textVisibleInPage("Do you have life insurance separate from your superannuation?");
		reviewConfirmPage.HaveLifeInsuranceSuperNo();
		CommonFunctions.textVisibleInPage("Do you control a trust?");
		reviewConfirmPage.HaveTrustNo();
		CommonFunctions.textVisibleInPage("Do you control a self-managed superannuation fund?");
		reviewConfirmPage.HaveSuperFundNo();
		CommonFunctions.textVisibleInPage("Do you own your own business, or are you a partner in a partnership?");
	...
	public void user_checks_the_Executors_summary_details() throws Throwable {
		CommonFunctions.textVisibleInPage("Who do you want to manage your estate?");
		// CommonFunctions.textVisibleInPage("Backup Executor");
		CommonFunctions.textVisibleInPage("Name:");
		// CommonFunctions.textVisibleInPage("Backup Test Upback");
		CommonFunctions.textVisibleInPage("Relationship:");
		// CommonFunctions.textVisibleInPage("Cousin");
		// CommonFunctions.textVisibleInPage("First Option Executor");
		CommonFunctions.textVisibleInPage("Name:");
		// CommonFunctions.textVisibleInPage("First Test Option");
		CommonFunctions.textVisibleInPage("Relationship:");
		// CommonFunctions.textVisibleInPage("Father");
		CommonFunctions.textVisibleInPage("Would you like Maurice Blackburn to assist with Managing your estate?");
		CommonFunctions.textVisibleInPage("Funeral Wishes");
		CommonFunctions.textVisibleInPage("I have no wishes");
	...
	public void user_checks_the_Beneficiaries_summary_details() throws Throwable {
		...
		CommonFunctions.textVisibleInPage("Do you wish to leave any gifts?");
	...
	public void user_clicks_yes_to_If_any_of_your_children_predecease_you_do_you_want_to_divide_it_equally_amongst_their_children_question()
			throws Throwable {
	...
	public void user_clicks_no_to_If_any_of_your_children_predecease_you_do_you_want_to_divide_it_equally_amongst_their_children_question()
			throws Throwable {
	...
	public void user_clicks_yes_to_Do_you_want_to_give_the_whole_estate_equally_to_your_children_question()
			throws Throwable {
	...
	public void user_clicks_no_to_Do_you_want_to_give_the_whole_estate_equally_to_your_children_question()
			throws Throwable {
	...
	public void user_clicks_yes_to_if_your_spouse_partner_predeceases_you_do_you_want_to_give_the_whole_of_your_estate_equally_to_any_children_you_have_in_the_future_question()
			throws Throwable {
		beneficiariesPage.ClickYesQuestion1();
		CommonFunctions.pause(5000, false);
	}
	...
	public void user_clicks_no_to_if_your_spouse_partner_predeceases_you_do_you_want_to_give_the_whole_of_your_estate_equally_to_any_children_you_have_in_the_future_question()
			throws Throwable {
	...
	public void user_clicks_yes_to_Do_you_want_to_leave_your_whole_estate_to_your_spouse_partner_if_they_survive_you_question()
			throws Throwable {
	...
	public void user_clicks_no_to_Do_you_want_to_leave_your_whole_estate_to_your_spouse_partner_if_they_survive_you_question()
			throws Throwable {
	...
	public void user_clicks_no_to_Do_you_want_to_include_any_children_you_have_in_the_future_question()
			throws Throwable {
		beneficiariesPage.ClickNoQuestion1();
		CommonFunctions.pause(5000, false);
	}
	...
	public void user_clicks_yes_to_Do_you_want_to_give_the_whole_of_your_estate_equally_to_any_children_you_have_in_the_future_question()
			throws Throwable {
		beneficiariesPage.ClickYesQuestion1();
		CommonFunctions.pause(5000, false);
	}
	...
	public void user_clicks_no_to_Do_you_want_to_give_the_whole_of_your_estate_equally_to_any_children_you_have_in_the_future_question()
			throws Throwable {
		beneficiariesPage.ClickNoQuestion1();
		CommonFunctions.pause(5000, false);
	}
	...
	public void user_clicks_yes_to_Do_you_intend_to_grant_any_life_interests_or_rights_to_occupy_in_your_Will_question()
			throws Throwable {
	...
	public void user_clicks_no_to_Do_you_intend_to_grant_any_life_interests_or_rights_to_occupy_in_your_Will_question()
			throws Throwable {
	...
	public void user_clicks_no_to_do_you_own_your_own_business_or_are_you_a_partner_in_a_partnership_question()
			throws Throwable {
	...
	public void user_clicks_yes_to_do_you_own_your_own_business_or_are_you_a_partner_in_a_partnership_question()
			throws Throwable {
	...
	public void user_sees_feedback_message_when_changing_from_Standard_Single_to_Mylife_Couple() throws Throwable {
		CommonFunctions.pause(10000, false);
	...
	@When("^user sees feedback message when changing from Standard Single to Mylife Single$")
	public void user_sees_feedback_message_when_changing_from_Standard_Single_to_Mylife_Single() throws Throwable {
		CommonFunctions.pause(10000, false);
		CommonFunctions.elementDisplayed(
				driver.findElement(By.xpath("//*[contains(text(),'Standard') and @class='modal-content']")));
		CommonFunctions.checkFeedbackMessageDisplayedContainsString("Will (Single)");
	...
	public void user_sees_feedback_message_when_changing_from_Mylife_Couple_to_Mylife_Single() throws Throwable {
		CommonFunctions.pause(5000, false);
		CommonFunctions
	...
	public void user_sees_relationship_status_is_unselected() throws Throwable {
		CommonFunctions.elementNotExistingByXPath("//option[@selected='selected']");
	}

	@When("^user sees ellipsis for updating or resending spouse email$")
	public void user_sees_ellipsis_for_updating_or_resending_spouse_email() throws Throwable {
		CommonFunctions.elementDisplayed(driver.findElement(By.xpath("(//span[@class='fa fa-fw fa-ellipsis-v'])[1]")));
	}

	@Then("^user sees email log tab link$")
	public void user_sees_email_log_tab_link() throws Throwable {
		CommonFunctions.elementDisplayed(driver.findElement(By.xpath("//div[text()='Email Log']")));
	}

	@Then("^user sees complete filters for emails$")
	public void user_sees_complete_filters_for_emails() throws Throwable {
		// search bar
		CommonFunctions.elementDisplayed(driver.findElement(By.xpath("//input[contains(@id,'SearchEmail')]")));
		// email filter
		CommonFunctions
				.elementDisplayed(driver.findElement(By.xpath("//span[text()='Email Subject']//following::select")));
		// DateRangeStart filter
		CommonFunctions.elementDisplayed(driver.findElement(
				By.xpath("//span[text()='Date range start']//following::input[contains(@id,'DateRangeStart')]")));
		// DateRangeStart filter
		CommonFunctions.elementDisplayed(driver.findElement(
				By.xpath("//span[text()='Date range end']//following::input[contains(@id,'DateRangeEnd')]")));

	}

	@When("^user clicks email log tab link$")
	public void user_clicks_email_log_tab_link() throws Throwable {
		homePage.ClickOnBackOfficeEmailChangeEmailLog();
	}

	@When("^user clicks more option on email log tab$")
	public void user_clicks_more_option_on_email_log_tab() throws Throwable {
		homePage.ClickOnBackOfficeEmailChangeEmailLogMoreOption();
	}

	@When("^user sees Resend Spouse Email Invitation popup displayed with corresponding details$")
	public void user_sees_Resend_Spouse_Email_Invitation_popup_displayed_with_corresponding_details() throws Throwable {
		CommonFunctions
				.elementDisplayed(driver.findElement(By.xpath("//label[text()='Resend Spouse Email Invitation']")));
		CommonFunctions.elementDisplayed(driver.findElement(By.xpath("//label[text()=\"Spouse's email address\"]")));
		CommonFunctions.elementDisplayed(driver.findElement(By.xpath("//input[contains(@id,'Partner_Email')]")));
		CommonFunctions.elementDisplayed(driver.findElement(By.xpath("//input[@value='Update']")));
	}

	@When("^user updates existing spouse email before resending$")
	public void user_updates_existing_spouse_email_before_resending() throws Throwable {
		homePage.setSpouseNewEmail("NewEmailSpouse@gmail.com");
		// homePage.ClickOnBackOfficeEmailChangeUpdateSpouseEmailButton();
	}

	@When("^user clicks update button on resend spouse email invitation popup$")
	public void user_clicks_update_button_on_resend_spouse_email_invitation_popup() throws Throwable {
		homePage.ClickOnBackOfficeEmailChangeUpdateSpouseEmailButton();
	}

	@When("^user clicks ellipsis for updating or resending spouse email$")
	public void user_clicks_ellipsis_for_updating_or_resending_spouse_email() throws Throwable {
		boolean x = false;
		do {
			if (driver.findElement(By.xpath("(//span[@class='fa fa-fw fa-ellipsis-v'])[1]")).isDisplayed()) {
				x = true;
				break;
			}
			homePage.ClickOnBackOfficeEmailChangeNexPage();
		} while (x == false);

		homePage.ClickOnBackOfficeEmailChangeEllipsis();
	}
	...
	@Then("^user is prompted about MB (\\d+) months policy rule$")
	public void user_is_prompted_about_MB_months_policy_rule(int arg1) throws Throwable {
		CommonFunctions.elementDisplayed(driver
				.findElement(By.xpath("//div[contains(@id,'WillSubmittedLastSixMonths') and @class='modal-content']")));
	}
	...
	public void user_checks_if_additional_questions_displayed_for_single_is_correct_when_single_product_is_selected()
			throws Throwable {
	...
	public void user_checks_if_additional_questions_displayed_for_single_is_correct_when_couple_product_is_selected()
			throws Throwable {
	...
	public void user_checks_if_additional_questions_displayed_for_widowed_is_correct_when_couple_product_is_selected()
			throws Throwable {
	...
	public void user_checks_if_additional_questions_displayed_for_married_is_correct_when_couple_product_is_selected()
			throws Throwable {
	...
	public void user_checks_if_additional_questions_displayed_for_separated_is_correct_when_couple_product_is_selected()
			throws Throwable {
	...
	public void user_checks_if_additional_questions_displayed_for_divorced_is_correct_when_couple_product_is_selected()
			throws Throwable {
		aboutPage.AdditionalQuestionsForSeparatedAndDivorced();
	}

	@When("^user checks if additional questions displayed for separated is correct when single product is selected$")
	public void user_checks_if_additional_questions_displayed_for_separated_is_correct_when_single_product_is_selected()
			throws Throwable {
		aboutPage.AdditionalQuestionsForSeparatedAndDivorced();
	}

	@When("^user checks if additional questions displayed for divorced is correct when single product is selected$")
	public void user_checks_if_additional_questions_displayed_for_divorced_is_correct_when_single_product_is_selected()
			throws Throwable {
		aboutPage.AdditionalQuestionsForSeparatedAndDivorced();
	}

	@When("^user checks if additional questions displayed for defacto is correct when couple product is selected$")
	public void user_checks_if_additional_questions_displayed_for_defacto_is_correct_when_couple_product_is_selected()
			throws Throwable {
	...
	public void user_checks_if_additional_questions_displayed_for_engaged_is_correct_when_couple_product_is_selected()
			throws Throwable {
		aboutPage.AdditionalQuestionsForDefactoAndEngaged();
	}

	@When("^user checks if additional questions displayed for married is correct when single product is selected$")
	public void user_checks_if_additional_questions_displayed_for_married_is_correct_when_single_product_is_selected()
			throws Throwable {
		aboutPage.AdditionalQuestionsForMarried();
	}

	@When("^user checks if additional questions displayed for defacto is correct when single product is selected$")
	public void user_checks_if_additional_questions_displayed_for_defacto_is_correct_when_single_product_is_selected()
			throws Throwable {
		aboutPage.AdditionalQuestionsForDefactoAndEngaged();
	}

	@When("^user checks if additional questions displayed for engaged is correct when single product is selected$")
	public void user_checks_if_additional_questions_displayed_for_engaged_is_correct_when_single_product_is_selected()
			throws Throwable {
		aboutPage.AdditionalQuestionsForDefactoAndEngaged();
	}

	@When("^user checks if additional questions displayed for widowed is correct when single product is selected$")
	public void user_checks_if_additional_questions_displayed_for_widowed_is_correct_when_single_product_is_selected()
			throws Throwable {
	...
	public void the_user_checks_if_Statuses_inside_the_Relationship_Status_dropdown_is_complete() throws Throwable {
		String[] RelStatus = { "Select One", "Single", "Defacto", "Engaged", "Married", "Widowed", "Separated",
				"Divorced" };
	...
	public void user_selects_Both_financial_and_personal_matters_on_enduring_power_of_attorney_options()
			throws Throwable {
		CommonFunctions.clickKeys(Keys.chord(Keys.PAGE_UP));
		CommonFunctions.pause(2000, false);
		CommonFunctions.clickKeys(Keys.chord(Keys.PAGE_UP));
	...
	public void user_selects_on_When_do_you_want_your_Financial_Personal_Decision_Makers_to_start_to_act_dropdown(
	...
	public void user_sees_mandatory_validation_inside_the_financial_decision_page_for_both_financial_and_personal_matters()
			throws Throwable {
	...
	public void user_sees_mandatory_validation_inside_the_financial_decision_page_for_both_financial_and_personal_matters_with_personal()
			throws Throwable {
	...
	public void user_sees_mandatory_validation_inside_the_financial_decision_page_for_financial_matters()
			throws Throwable {
	...
	public void user_checks_if_add_financial_decision_maker_button_on_financial_decision_page_is_hidden()
			throws Throwable {
	...
	public void user_checks_if_add_personal_decision_maker_button_on_financial_decision_page_is_hidden()
			throws Throwable {
	...
	public void user_sees_mandatory_validation_inside_the_financial_decision_page_for_personal_matters()
			throws Throwable {
	...
	public void user_clicks_no_to_Would_you_like_Maurice_Blackburn_to_help_your_Executor_manage_your_estate_question()
			throws Throwable {
	...
	public void user_clicks_on_Back_button_on_personal_page() throws Throwable {
		homePage = personalPage.ClickBackButton();
		CommonFunctions.clickKeys(Keys.chord(Keys.PAGE_DOWN));
		CommonFunctions.pause(5000, false);
	}
	...
	@When("^user click change button on personal page from about you page$")
	public void user_click_change_button_on_personal_page_from_about_you_page() throws Throwable {
		personalPage = aboutPage.ClickChangeButtonPersonal();
		CommonFunctions.clickKeys(Keys.chord(Keys.PAGE_DOWN));
		CommonFunctions.pause(5000, false);
	}

	@When("^user click change button on personal page from assets page$")
	...
	public void user_checks_if_validations_of_fields_inside_the_adding_of_property_asset_is_implemented()
			throws Throwable {
	...
	public void user_checks_if_validations_of_fields_inside_the_adding_of_bank_account_asset_is_implemented()
			throws Throwable {
	...
	public void user_checks_if_validations_of_fields_inside_the_adding_of_vehicle_asset_is_implemented()
			throws Throwable {
	...
	public void user_checks_if_validations_of_fields_inside_the_adding_of_shares_asset_is_implemented()
			throws Throwable {
	...
	public void user_checks_if_validations_of_fields_inside_the_adding_of_other_asset_is_implemented()
			throws Throwable {
	...
	public void user_clicks_yes_to_If_your_spouse_partner_predeceases_you_do_you_want_to_give_the_whole_estate_equally_to_your_children_question()
			throws Throwable {
		beneficiariesPage.ClickYesQuestion1SingleWithChildren();
		CommonFunctions.pause(5000, false);
	}
	...
	public void user_clicks_no_to_If_your_spouse_partner_predeceases_you_do_you_want_to_give_the_whole_estate_equally_to_your_children_question()
			throws Throwable {
		beneficiariesPage.ClickNoQuestion1SingleWithChildren();
		CommonFunctions.pause(5000, false);
	}
	...
	public void user_checks_if_validation_on_mandatory_fields_inside_the_adding_of_guardian_is_implemented()
			throws Throwable {
	...
	@Then("^user sees union membership dropdown$")
	public void user_sees_union_membership_dropdown() throws Throwable {
		CommonFunctions.elementDisplayed(
	...
	public void user_adds_union_membership() throws Throwable {
		paymentsPage.selectValueFromUnionDropdown("Alpha");
		CommonFunctions.pause(5000, false);
		paymentsPage.setValueForUnion("AAAA");
		CommonFunctions.pause(5000, false);
		paymentsPage.clickApplyUnionButton();
		CommonFunctions.pause(5000, false);
	...
	public void user_logs_into_app_with_the_and_as_the_admin_login_credentials(String arg1, String arg2)
			throws Throwable {
	...
	public void the_user_clicks_on_create_account_button() throws Throwable {
		...
		CommonFunctions.pause(8000, false);
	}
	...
	public void user_checks_if_describe_field_is_displayed_when_is_selected_as_source_dropdown(String arg1)
			throws Throwable {
		registrationPage.SelectValueOnSourceDropdown(arg1);
	...
	public void user_checks_if_describe_field_is_mandatory_field_when_is_selected_as_source_dropdown(String arg1)
			throws Throwable {
		registrationPage.SelectValueOnSourceDropdown(arg1);
		CommonFunctions.pause(5000, false);
		registrationPage.clickCreateAccountButton();
	...
	public void user_sees_logout_prompt_with_buttons_Yes_log_out_and_Cancel() throws Throwable {
		// CommonFunctions.switchFrameByXPath("//*[text() = 'Are you sure you want to
		// log out?']");
	...
	public void user_clicks_back_button_on_review_and_confirm_page_to_go_back_to_medical_decision_page()
			throws Throwable {
	...
	public void user_selects_no_on_Do_you_have_an_Advance_Care_Directive_currently_in_place_question()
			throws Throwable {
	...
	public void user_checks_the_information_inside_the_review_and_confirm_after_medical_POA_page() throws Throwable {
		...
		CommonFunctions.textVisibleInPage("Financial Decision Maker");
		CommonFunctions.textVisibleInPage("Primary Financial Power of Attorney");
		CommonFunctions.textVisibleInPage("Name:");
		CommonFunctions.textVisibleInPage("Demeth Rey Camuin");
		CommonFunctions.textVisibleInPage("Relationship:");
		CommonFunctions.textVisibleInPage("Son");
		CommonFunctions.textVisibleInPage("When do you want your Financial/Personal Decision Makers to start to act?");
		CommonFunctions.textVisibleInPage("Immediately");
		CommonFunctions.textVisibleInPage("Are there any limitations that you would like to discuss?");
		// CommonFunctions.textVisibleInPage("This a test Limitation");
		CommonFunctions.textVisibleInPage("Medical Power of Attorney");
		CommonFunctions.textVisibleInPage("I do not want to appoint a Medical Decision Maker");
	...
	public void poa_is_displayed_in_the_order_summary() throws Throwable {
		CommonFunctions.textVisibleInPage("Power of Attorney");
	...
	public void standard_will_legal_document_is_displayed_in_the_order_summary() throws Throwable {
		CommonFunctions.textVisibleInPage("Standard");
		CommonFunctions.pause(5000, false);
	...
	// @When("^user clicks the next button on the review and confirm page to go to
	// payments page$")
	// public void
	// user_clicks_the_next_button_on_the_review_and_confirm_page_to_go_to_payments_page()
	// throws Throwable {
	// paymentsPage = reviewConfirmPage.ClickNextButtonPayment();
	// }
	...
	public void user_sees_no_forms_in_the_dashboard() throws Throwable {
		CommonFunctions.textVisibleInPage("No form items to show...");
	}
	...
	public void user_fill_up_edit_union_details() throws Throwable {
		...
		// unionListPage.fillUpEditUnionDetails_numeric_alphanumeric();for MW -
		// 114,115,177
	}

	@Then("^user check for the edited union$")
	public void user_check_for_the_edited_union() throws Throwable {
		CommonFunctions.textVisibleInPage("AlphaNumeric01");
	}
	...
	public void user_checks_the_content_of_upload_will_tooltip() throws Throwable {
		...
		CommonFunctions.pause(2000, false);
		CommonFunctions.textVisibleInPage(
				"It is helpful for us to see a copy of your old Will to understand how your wishes have changed. This may impact the advice we give you. DO NOT unstaple or damage your old Will as this may make it invalid.");
	}
	...
	public void user_checks_the_content_of_Death_beneficiary_tooltip() throws Throwable {
		...
		CommonFunctions.pause(1500, false);
		CommonFunctions.textVisibleInPage(
				"Your superannuation is not automatically covered by your Will. You should contact your superannuation fund or advisor directly to find out whether you require a Binding Death Benefit Nomination or other documentation to direct the payment of your superannuation death benefits. There may be different tax consequences depending on your nominated beneficiaries and you should seek financial advice.");
		// CommonFunctions.textVisibleInPage("If you do not have a valid Binding Death
		// Benefit Nomination at the date of your death then the Trustee of the
		// superannuation fund may have the
		// discretion to determine how your death benefits are paid. If your nomination
		// is Non-Binding then your superannuation fund may take it into consideration
		// but will not be bound to pay your
	...
	public void user_checks_the_content_of_binding_tooltip() throws Throwable {
		...
		CommonFunctions.pause(1500, false);
		CommonFunctions.textVisibleInPage(
				"A nomination is binding if you have nominated a dependent or interdependent. This may include your spouse or children. You should contact your Superannuation fund to check this definition.");
	}
	...
	public void user_checks_the_content_of_life_interest_tooltip() throws Throwable {
		...
		CommonFunctions.pause(1500, false);
		CommonFunctions.textVisibleInPage(
				"A life interest allows you to give property to another person for their lifetime, and upon their death, the asset can be given to someone else.");
	}
	...
	public void user_checks_the_content_of_beneficiaries_tooltip() throws Throwable {
		...
		CommonFunctions.pause(1500, false);
		CommonFunctions.textVisibleInPage(
				"Your Beneficiaries are the people you want to leave your estate to. Estate is the word used to refer to the assets that you own in your sole name when you die.");
	}
	...
	public void user_checks_the_content_of_executors_tooltip() throws Throwable {
		...
		CommonFunctions.pause(1500, false);
		CommonFunctions.textVisibleInPage(
				"Your Executor (also known as your Trustee) is the person or people who are responsible for ensuring that the terms of your Will are carried out after your death.  ");
	}
	...
	public void user_checks_the_content_of_Lawyers_of_Your_Estate_tooltip() throws Throwable {
		...
		CommonFunctions.pause(1500, false);
		CommonFunctions.textVisibleInPage(
				"Your Executors may need help in dealing with the legal aspects of the estate after your death including applying to the Court for a Grant of Probate. You can include a wish that Maurice Blackburn is to assist your Executors with this process. This wish is not binding on your executors and if they would prefer to do it themselves or use another lawyer then they are free to do so.");
	}
	...
	public void user_opens_browser_and_proceeds_to_orders_page() throws Exception {
		driver.get(prop.getProperty("orders"));
...
//		CommonFunctions.pause(5000, false);
	...
	public void user_click_YES_on_Do_you_want_to_give_the_whole_of_your_estate_equally_to_any_children_you_have_in_the_future_question()
			throws Throwable {
		beneficiariesPage.ClickYesQuestion1();
	}
	...
	public void user_click_NO_on_Do_you_want_to_give_the_whole_of_your_estate_equally_to_any_children_you_have_in_the_future_question()
			throws Throwable {
		beneficiariesPage.ClickNoQuestion1();
	}
	...
	public void user_click_NO_If_any_of_your_children_predecease_you_do_you_want_to_divide_that_child_s_share_equally_among_their_children_question()
			throws Throwable {
		beneficiariesPage.ClickNoQuestion2();
	...
	public void user_clicks_the_next_button_on_the_review_and_confirm_page_to_go_to_pending_spouse_page()
			throws Throwable {

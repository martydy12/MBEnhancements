...
public class PendingSpousePage extends Base {
	...
	public PendingSpousePage()throws Exception{
		PageFactory.initElements(driver, this);
	}

	// ============================================================= Actions =============================================================
	public AssetsPage ClickSaveRecord()throws Exception{
		CommonFunctions.clickElement(btn_SaveRecord);

		return new AssetsPage();
	}

	public void displayThankYou()throws Exception{
		CommonFunctions.elementDisplayed(txt_ThankYou);
	}

	public void displayPendingSpouse()throws Exception{

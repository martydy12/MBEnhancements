...
public class MedicalDecisionsPage extends Base {
	...
	public MedicalDecisionsPage()throws Exception{
		PageFactory.initElements(driver, this);
	}

	// ============================================================= Actions =============================================================
	public void clickRemoveDecisionMaker()throws Exception{
		CommonFunctions.clickElement(RemoveDecisionMaker);
	}

	public void clickEditDecisionMaker()throws Exception{
		CommonFunctions.clickElement(EditDecisionMaker);
	}

	public void clickAddDecisionMaker()throws Exception{
	...
	public void DecisionMAkerMandatoryFieldsOnAddingOne()throws Exception{
	...
	public void SetDecisionMakerMandatoryFields()throws Exception{
	...
	public void EditDecisionMakerMandatoryFields()throws Exception{
		CommonFunctions.selectValueFromDropdown(POATitle, "Dr");
	...
	public void DisplayedDecisionMakerReq()throws Exception{
	...
	public FinancialDecisionsPage ClickBackButton()throws Exception{
		CommonFunctions.clickElement(btn_Back);

		return new FinancialDecisionsPage();
	}

	public void clickMedicalDecisionMaker_Tooltip()throws Exception{
		CommonFunctions.clickElement(MedicalDecisionMaker_Tooltip);
	}

	public void clickAdvanceCare_Tooltip()throws Exception{
		CommonFunctions.clickElement(AdvanceCare_Tooltip);
	}

	public void DisplayMedicalDecisionMaker_Tooltip()throws Exception{
		CommonFunctions.elementDisplayed(MedicalDecisionMaker_Tooltip);
	}

	public void DisplayAdvanceCare_Tooltip()throws Exception{

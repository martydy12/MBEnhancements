Feature: MW - 49 : Affiliated Unions
  ...
  Scenario Outline: MW - 49 - Alphanumeric - pre
    # Go to site and log in
    Given user opens browser
    When user logs into app with the "<email>" and "<password>" as the login credentials
    Then user is on "Landing" page
    ...
    When user selects "Alphanumeric-pre" as affliated unions
    And user enter "ab1" on your member number
    And user click on confirm button
    And user is on "Landing" page
    And user check the cost
    #User cancel union-----------------------------------------------------
  ...
  Scenario Outline: MW - 49 - Alphanumeric-Suf
    # Go to site and log in
    Given user opens browser
    When user logs into app with the "<email>" and "<password>" as the login credentials
    Then user is on "Landing" page
  ...
  Scenario Outline: MW - 49 - Numeric
    # Go to site and log in
    Given user opens browser
    When user logs into app with the "<email>" and "<password>" as the login credentials
    Then user is on "Landing" page
